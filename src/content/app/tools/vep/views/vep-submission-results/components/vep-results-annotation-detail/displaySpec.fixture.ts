          ...
          "blocks": [
            {
              ...
              "rows": [
                ...
                },
                {
                  "label": "Donor gain",
                  "values": [
                    "spliceai.ds_donor_gain",
                    "spliceai.dp_donor_gain"
                  ]
                },
                {
                  "label": "Donor loss",
                  "values": [
                    "spliceai.ds_donor_loss",
                    "spliceai.dp_donor_loss"
                  ]
                }
              ]
            }
            ...
            "cells": [
              {
                ...
                "link": {
                  "kind": "external",
                  "template": "https://platform.opentargets.org/disease/{disease}",
                  "builder": null
                }
              },
              {
              ...
              "rows": [
                {
                  ...
                  "link": {
                    "kind": "external",
                    "template": "https://www.ncbi.nlm.nih.gov/clinvar/variation/{value}/",
                    "builder": null
                  }
                }
              ]
          ...
          "columns": [
            {
              ...
              "link": {
                "kind": "external",
                "template": "https://www.ebi.ac.uk/intact/details/interaction/{value}",
                "builder": null
              },
              "split": null,
              "link_prefix": null,
