...
Enter sequence:
  -> nucleotide sequence detected
    change database
      -> sequence remains nucleotide


Change database
  -> change sequence type
  -> database should be marked as manually changed

Change program while a nucleotide-based database is selected
  then, change the database to another nucleotide-based database (genomic -> transcripts)
    -> program shouldn't change
...
After manual updates
  ...
  Change database when sequence type has been manually changed
    Sequence type remains unchanged
  
  Change sequence type after the database has been changed
    Database type should remain unchanged
  

All together now
  Change database type to protein
    -> sequence type should have been automatically changed to protein
     Enter a nucleotide sequence in the box
      -> sequence type should change to nucleotide?





Setting no sequences means resetting 
