  ...
  endpoints: (builder) => ({
    ...
    >({
      query: (params) => {
        ...
        return {
          url: `${config.regulationApiBaseUrl}/annotation/v0.15/release/${releaseName}/assembly/${assemblyId}/availability`
        };
      }
    }),
    regionOverview: builder.query<OverviewRegion, RegionOverviewRequestParams>({
      query: (params) => {
        ...
        return {
          url: `${config.regulationApiBaseUrl}/annotation/v0.15/release/${releaseName}/assembly/${assemblyId}?location=${location}`
        };
      }
    }),
    focusGene: builder.query<FocusGene, FocusGeneRequestParams>({
      queryFn: async (params, _, __, baseQuery) => {
        ...
        try {
          const url = `${config.regulationApiBaseUrl}/annotation/v0.15/release/${releaseName}/assembly/${assemblyId}/gene/${geneId}`;
    ...
    baseEpigenomes: builder.query<Epigenome[], BaseEpigenomesRequestParams>({
      query: (params) => ({
        url: `${config.regulationApiBaseUrl}/epigenomes/v0.9/release/${releaseName}/base_epigenomes/assembly/${params.assemblyId}`
      })
    }),
    ...
    >({
      query: (params) => ({
        url: `${config.regulationApiBaseUrl}/epigenomes/v0.9/release/${releaseName}/metadata_dimensions/assembly/${params.assemblyId}`
      })
    }),
    ...
    >({
      queryFn: async (params, _, __, baseQuery) => {
        ...
        const url = `${config.regulationApiBaseUrl}/epigenomes/v0.9/release/${releaseName}/region_activity/assembly/${assemblyId}`;
        const requestBody = {
    ...
    >({
      queryFn: async (params, _, __, baseQuery) => {
        ...
        const url = `${config.regulationApiBaseUrl}/epigenomes/v0.9/release/${releaseName}/labels/assembly/${assemblyId}?add_nbsp=true`;
        const requestBody = {
    ...
    >({
      queryFn: async (params, _, __, baseQuery) => {
        ...
        const url = `${config.regulationApiBaseUrl}/epigenomes/v0.9/release/${releaseName}/gene_activity/assembly/${assemblyId}/gene/${geneId}`;
        const requestBody = {
          epigenome_ids: prepareEpigenomeIdsForRequest(epigenomeIds)
        };
