...
jest.mock(
  'src/content/app/genome-browser/components/browser-region-editor/BrowserRegionEditor',
  () => () => <div className="browserRegionEditor" />
);
jest.mock(
  'src/content/app/genome-browser/components/browser-region-field/BrowserRegionField',
