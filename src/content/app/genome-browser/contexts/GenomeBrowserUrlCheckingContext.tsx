...
type GenomeBrowserUrlCheckingContextType = {
...
const defaultContext: GenomeBrowserUrlCheckingContextType = {
...
export const GenomeBrowserUrlCheckingContext =
  React.createContext<GenomeBrowserUrlCheckingContextType>(defaultContext);

type Props = {
  children: ReactNode;
};

const GenomeBrowserUrlCheckingContextContainer = (props: Props) => {
  const contextValue = useGenomeBrowserUrlCheck();

  return (
    <GenomeBrowserUrlCheckingContext.Provider value={contextValue}>
      {props.children}
    </GenomeBrowserUrlCheckingContext.Provider>
  );
};
...
export default GenomeBrowserUrlCheckingContextContainer;
