...
import { browserNavIconActionMap } from 'src/content/app/browser/state/browserState';

import { BrowserNavItem } from 'src/content/app/browser/helpers/browserConfig';
