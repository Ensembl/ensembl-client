...
import * as browserHelper from 'src/content/app/browser/helpers/browserHelper';
import * as browserActions from 'src/content/app/browser/state/browserActions';

jest.mock('src/content/app/browser/helpers/browserHelper', () => {
  const originalModule = jest.requireActual(
    'src/content/app/browser/helpers/browserHelper'
  );
