...
export const sampleData: RawSpeciesStats = {
  ...
  triticum_aestivum_GCA_900519105_1: {
    assembly_stats: {
      ...
      sex: 'NA',
      breed_cultivar_strain: 'reference (Chinese spring)',
      taxonomy_id: '4565',
    ...
    pseudogene_stats: {
      scientific_name: 'Triticum aestivum',
      pseudogenes: '0',
      average_genomic_span: 'NA',
      average_sequence_length: 'NA',
      shortest_gene: 'NA',
      longest_gene: 'NA',
      total_transcripts: 'NA',
      transcripts_per_gene: 'NA',
      total_exons: 'NA',
      average_exon_length: 'NA',
      average_exons_per_transcript: 'NA',
      total_introns: 'NA',
      average_intron_length: 'NA'
    }
  },
