...
const ZmenuController = (props: Props) => {
  ...
  const handleZmenuCreate = (payload: ZmenuCreateMessage['payload']) => {
    const newZmenu = {
      id: payload.id,
