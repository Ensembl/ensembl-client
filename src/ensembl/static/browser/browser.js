...
<<<<<<< HEAD
            var wasm_path = path.join( __dirname, "/static/browser/browser-5d7f112d83efa80b127b6a9da1fdc574.wasm" );
=======
            var wasm_path = path.join( __dirname, "/static/browser/browser-ae29a85c85532946df45d42dd0be644c.wasm" );
>>>>>>> dev
...
<<<<<<< HEAD
            var file = fetch( "/static/browser/browser-5d7f112d83efa80b127b6a9da1fdc574.wasm", {credentials: "same-origin"} );
=======
            var file = fetch( "/static/browser/browser-ae29a85c85532946df45d42dd0be644c.wasm", {credentials: "same-origin"} );
>>>>>>> dev
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_291de3e6c57138a2a456b31f08593092eb1d9d5a": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);window.postMessage(($0),"*");
            },
            ...
            "__cargo_web_snippet_60b38404bdebea2bdd130dee3d37c94692afdf17": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return document.body.contains(($1));})());
            },
            ...
            "__cargo_web_snippet_fc59e55ec627d556710dcf269af3773f6819aa3d": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return($1).documentElement;})());
            },
