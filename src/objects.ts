...
import * as browserActions from './content/app/browser/state/browserActions';
import * as customDownloadActions from './content/app/custom-download/state/customDownloadActions';
import * as trackPanelActions from './content/app/browser/components/track-panel/state/trackPanelActions';
