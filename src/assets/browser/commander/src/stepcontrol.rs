...
impl StepControl {
    pub(crate) fn new(task_control: &TaskContext) -> StepControl {
        StepControl {
    ...
    pub fn task_control(&mut self) -> &mut TaskContext {
...
mod test {
    ...
    pub fn test_block_on_tick() {
        ...
        let mut tc = TaskContext::new(&cfg,&timers,&eah,&h,&integration);
