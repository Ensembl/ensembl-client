...
import styles from './LinearFractionIndicator.scss';
...
const LinearFractionIndicator = (props: Props) => {
  const { value, valueFormatOptions = defaultValueFormatOptions } = props;

  const diagramStyles = {
    ['--linear-fraction-indicator-value' as string]: `${props.value}%`
  };
...
export default LinearFractionIndicator;
