...
export type BaseApiUrls = {
  ...
  regulationExternalBaseUrl: string;
};
...
export const defaultApiUrls: BaseApiUrls = {
  ...
  regulationExternalBaseUrl: 'https://regulation.ensembl.org'
};
...
const getBaseApiUrls = (): BaseApiUrls => {
  ...
  return {
    ...
    regulationExternalBaseUrl: defaultApiUrls.regulationExternalBaseUrl
  };
};
