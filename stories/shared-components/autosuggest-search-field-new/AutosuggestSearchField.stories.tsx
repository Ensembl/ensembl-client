...
import AutosuggestSearchField from 'src/shared/components/autosuggest-search-field-new/AutosuggestSearchField';
import Suggestions from './Suggestions';
import { SecondaryButton } from 'src/shared/components/button/Button';

// FIXME: remember to delete 'tests/data/species-selector/species-search', which is only used by the old AutosuggestSearchField component
...
export default {
  title: 'Components/Shared Components/AutosuggestSearchField-New'
};
